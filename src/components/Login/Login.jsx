   ...
   const handleSubmitLogin = (e) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <div>
            <img className=" flex  items-center " src={forest} alt="" />
            <div className="flex  items-center absolute  w-[132px] h-[132px] border-4 rounded-full border-[#0D9488]">< /div>
            </div>
                <h1 className="flex items-center justify-center font-extrabold leading-9 text-3xl p-2">Iniciar sesión</h1>
